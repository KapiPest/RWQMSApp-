...
public class AdminDashboard extends AppCompatActivity implements ValueEventListener, View.OnClickListener {

    String Time;
    SimpleDateFormat simpleTimeFormat, simpleDateFormat;
    Calendar calendar;
    private TextView date, waterTemperatureParameterTime, waterTurbidityParameterTime, waterPhParameterTime;
    private TextView waterTempVal, waterTurbidityVal, waterPhVal;
    private TextView waterTempStat, waterTurbidityStat, waterPhStat;

    public ImageView analyticsBtn, contactsBtn, sensorsBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*FOR THE BUTTONS IN THE LOWER PART*/
